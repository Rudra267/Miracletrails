        ...
        d = {
          ...
          on: {
            slideChange: function () {
              setTimeout(function () {
                u.params.mousewheel.releaseOnEdges = !1;
              }, 500);
            },
            reachEnd: function () {
              setTimeout(function () {
                u.params.mousewheel.releaseOnEdges = !0;
              }, 750);
            },
          },
        },
...
// var swiper = new Swiper("#teamSlider4", {
//   slidesPerView: 1,
//   spaceBetween: 20,
//   loop: true,
//   loopAdditionalSlides: 10, // ज्यादा रखो ताकि preloading smooth हो
//   watchSlidesProgress: true, // important for early loading
//   watchSlidesVisibility: true, // helps preload upcoming slides
//   preloadImages: true,
//   lazy: {
//     loadPrevNext: true,
//     loadPrevNextAmount: 4, // कितनी slides पहले/बाद में preload हों
//   },
//   breakpoints: {
//     576: { slidesPerView: 1 },
//     768: { slidesPerView: 2 },
